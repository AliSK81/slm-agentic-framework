#!/usr/bin/env python3
"""Copy cited trace artifacts into artifacts/repro_bundle/ (no secrets, no workspaces)."""
...
def make_repro_bundle(
    *,
    ...
    """Validate cited runs and copy JSONL, manifests, and decision logs into a bundle.
    ...
    Side effects:
        Creates output_dir; writes MANIFEST_INDEX.md; copies cited files only.
    """
